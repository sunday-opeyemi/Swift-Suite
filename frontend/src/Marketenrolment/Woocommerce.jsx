...
const Woocommerce = () => {
  ...
  const Schema = yup.object().shape({
    ...
    keyconsumer: yup.string().required(),
  ...
  const onSubmit = (data) => {
    const formData = { ...data, marketPlaceRegion: selectedCountry };
  ...
  return (
    <>
      <p className='relative lg:top-4 md:top-[-2px] lg:left-0 md:left-10 ms-3 top-[-4px] font-bold text-xl'>Edit Woo-commerce Account</p>
          ...
          <div className='bg-white lg:w-[100%] w-[93%] md:w-[90%] lg:ms-0 md:ms-10 lg:h-[20%] ms-3 py-10 lg:mt-8 mt-0'>
            <div>
              ...
              <div className='flex  lg:gap-28 md:gap-12 mt-5 h-10 px-5'>
                ...
                <input {...register("priceupdate")} type="checkbox" onChange={() => setPrice(!price)} checked={price} className='lg:mt-0 mt-2 md:mt-2 border h-[20px]  border-gray-500 focus:outline-none py-1 rounded' />
              </div>
              <div className='flex  lg:gap-28 md:gap-12 mt-5 h-10 px-5'>
                <h3 className='text-sm font-semibold w-[55%] md:w-[52%] lg:w-[30%]'>Enable Quantity Update:</h3>
                <input {...register("quantityupdate")} type="checkbox" onChange={() => setQuantity(!quantity)} checked={quantity} className='lg:mt-0 mt-2 md:mt-2 border h-[20px] border-gray-500 focus:outline-none py-1 rounded' />
              </div>
              <div>
                <div className='flex lg:gap-28 md:gap-12 mt-5 px-5'>
