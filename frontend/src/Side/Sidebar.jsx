      ...
      <motion.div ref={sidebarRef} variants={Nav_animation} initial={{ x: isTablet ? -250 : 0 }} animate={sideBarOpen ? "open" : "closed"} className="shadow-xl md:z-[9] z-[9999] max-w-[16rem]  w-[16rem] fixed top-0 left-0 h-screen">
        ...
        <div className="flex flex-col text-4xl bg-white text-black h-full">
          <ul className=" px-2.5 text-[0.9rem] py-5 flex flex-col gap-2  font-serif   dark:scrollbar-track-slate-400  dark:scrollbar-thumb-slate-700  md:h-[78%] h-[75%]">
            <li>
              <NavLink to={"/layout/home"} className="link flex gap-8 font-[Mirza] hover:rounded hover:text-black">
                <AiOutlineAppstore size={23} className="mt-2 min-w-max" />
                Dashboard
              </NavLink>
            </li>
            <li className="flex lg:gap-10 gap-5">
              <NavLink to={"/layout/catalogue"} className="link flex font-[Mirza] gap-8 hover:text-green-700 ">
            ...
            <li>
              <li className={`ms-14 font-[Mirza] shadow w-20 p-2 mt-[-4%] ${host ? 'block' : 'hidden'}`}>
                <p>
              ...
              <NavLink to={"/layout/inventory"} className="link font-[Mirza] flex gap-8 hover:text-green-700">
            ...
            <li>
              <NavLink to={""} className="link font-[Mirza] flex gap-8 hover:text-green-700">
            ...
            <li>
              <NavLink to={"/signin"} className="link font-[Mirza] flex gap-8 hover:text-green-700">
