...
const navigate = useNavigate()
  ...
  const onSubmit = (data) => {
    const formData = { ...store, ...data, categoryChecked, product_category: []};
    console.log(formData);
    setMyLoader(true)
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div></div>
              ...
              <div className='flex gap-5 lg:gap-2 border-b md:gap-[70px] mt-5 h-10 px-5'>
                ...
                <input {...register("shipping_cost_average")} type="checkbox" onChange={() => setIsChecked(!isChecked)} checked={isChecked} className='lg:mt-0 mt-2 md:mt-2 border h-[20px] w-[15%] lg:w-[40%] border-gray-500 focus:outline-none py-1 rounded' />
              </div>
