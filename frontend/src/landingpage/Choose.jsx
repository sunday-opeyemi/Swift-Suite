...
const Choose = () => {
    return (
        <div>
            <h1 className='text-center text-2xl font-bold mt-16 font-[font-PlayfairDisplay]'>Why Choose Us</h1>
            <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 mt-10 lg:px-[30%] md:px-[10%] px-[10%] gap-10'>
                <div className='bg-green-800 p-5 font-[font-PlayfairDisplay] text-white rounded-lg py-10 lg:h-[100%] transition duration-500 ease-in-out transform hover:scale-105'>
                    <img src={ico4} alt="" />
                ...
                <div className='bg-gray-300 font-[font-PlayfairDisplay] p-5 rounded-lg lg:h-[100%] transition duration-500 ease-in-out transform hover:scale-105'>
                    <img src={ico2} alt="" />
                ...
                <div className='bg-gray-300 p-5 font-[font-PlayfairDisplay] rounded-lg transition duration-500 ease-in-out transform hover:scale-105'>
                    <img src={ico3} alt="" />
                ...
                <div className='bg-green-800 text-white p-5 font-[font-PlayfairDisplay] rounded-lg transition duration-500 ease-in-out transform hover:scale-105'>
                    <img src={ico1} alt="" />
