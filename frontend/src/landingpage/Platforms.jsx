    ...
    return (
        <>
            ...
            <div className='text-2xl lg:text-xl grid lg:grid-cols-5 md:grid-cols-2 grid-cols-1 text-center lg:px-10 lg:mt-0 mt-3 p-5'>
                <div className='border shadow-lg lg:w-[80%] w-[80%] bg-[#F2EFEF] p-2 mx-auto py-5 lg:h-[95%] md:h-[100%] rounded transition duration-500 ease-in-out transform hover:scale-105'>
                ...
                <div className='border shadow-lg lg:w-[80%] w-[80%] bg-[#E7F4EE] mx-auto p-2 py-5 lg:mt-0 md:mt-0 mt-10 md:h-[95%] lg:h-[95%]  rounded transition duration-500 ease-in-out transform hover:scale-105'>
                ...
                <div className='border shadow-lg lg:w-[80%] w-[80%] bg-[#F2EFEF] mx-auto p-2 py-5 md:h-[80%] lg:h-[95%] lg:mt-0 mt-10 rounded transition duration-500 ease-in-out transform hover:scale-105'>
                ...
                <div className='border shadow-lg lg:w-[80%] w-[80%] bg-[#E7F4EE] mx-auto p-2 py-5 h-[95%] md:h-[80%] lg:h-[95%] lg:mt-0 mt-10 rounded transition duration-500 ease-in-out transform hover:scale-105'>
                ...
                <div className='border shadow-lg lg:w-[80%] w-[80%] bg-[#F2EFEF] mx-auto p-2 py-5 h-[95%] md:h-[80%] lg:h-[95%] lg:mt-0 mt-16 rounded transition duration-500 ease-in-out transform hover:scale-105'>
