        ...
        <section className='grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1'>
            ...
            <div className='lg:py-20 py-0   lg:px-28 px-14 '>
              ...
              <p className='flex my-4 font-bold text-xl text-[#089451]'>Sign Up</p>
                ...
                <button type='submit' className='w-full bg-[#089451] flex justify-center items-center  rounded  h-[40px] text-white font-bold py-3 mt-5 mb-10'>{myloader? <img src={gif} alt="" className='w-[25px] ' /> : 'Sign Up'}</button>
              </form>
            </div>
        </section>
